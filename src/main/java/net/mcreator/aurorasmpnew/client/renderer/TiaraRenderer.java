...
public class TiaraRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("aurorasmpnew", "textures/entities/tiara.png");
	private final ModelTiara model;

	public TiaraRenderer() {
		this.model = new ModelTiara(Minecraft.getInstance().getEntityModels().bakeLayer(AurorasmpnewModLayerDefinitions.TIARA));
	}

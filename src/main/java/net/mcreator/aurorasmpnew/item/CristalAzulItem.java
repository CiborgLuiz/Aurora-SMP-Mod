...
import net.mcreator.aurorasmpnew.procedures.CristalAzulWhileBaubleIsEquippedTickProcedure;
import net.mcreator.aurorasmpnew.init.AurorasmpnewModTabs;

import java.util.List;

public class CristalAzulItem extends Item implements ICurioItem {
	public CristalAzulItem() {
	...
	public void curioTick(SlotContext slotContext, ItemStack stack) {
		CristalAzulWhileBaubleIsEquippedTickProcedure.execute(slotContext.entity());
	}
}

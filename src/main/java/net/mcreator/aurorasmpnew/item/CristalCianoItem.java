...
import net.mcreator.aurorasmpnew.procedures.CristalCianoWhileBaubleIsEquippedTickProcedure;
import net.mcreator.aurorasmpnew.init.AurorasmpnewModTabs;

import java.util.List;

public class CristalCianoItem extends Item implements ICurioItem {
	public CristalCianoItem() {
	...
	public void curioTick(SlotContext slotContext, ItemStack stack) {
		CristalCianoWhileBaubleIsEquippedTickProcedure.execute(slotContext.entity());
	}
}

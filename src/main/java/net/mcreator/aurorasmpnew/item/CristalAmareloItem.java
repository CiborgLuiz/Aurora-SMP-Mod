...
import net.mcreator.aurorasmpnew.procedures.CristalAmareloWhileBaubleIsEquippedTickProcedure;
import net.mcreator.aurorasmpnew.init.AurorasmpnewModTabs;

import java.util.List;

public class CristalAmareloItem extends Item implements ICurioItem {
	public CristalAmareloItem() {
	...
	public void curioTick(SlotContext slotContext, ItemStack stack) {
		CristalAmareloWhileBaubleIsEquippedTickProcedure.execute(slotContext.entity());
	}
}

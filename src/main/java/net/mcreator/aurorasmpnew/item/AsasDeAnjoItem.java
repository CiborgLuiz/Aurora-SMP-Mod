...
import net.mcreator.aurorasmpnew.procedures.AsasDeAnjoBodyTickEventProcedure;

import java.util.List;

public class AsasDeAnjoItem extends GeoArmorItem implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";

	public AsasDeAnjoItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		if (itemstack.getItem() instanceof AsasDeAnjoItem armor && armor.slot == EquipmentSlot.CHEST) {
	...
	public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
		if (itemstack.getItem() instanceof AsasDeAnjoItem armor && armor.slot == EquipmentSlot.CHEST)
			AsasDeAnjoBodyTickEventProcedure.execute(entity, itemstack);
	}

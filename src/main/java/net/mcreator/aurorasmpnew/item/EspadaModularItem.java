...
public class EspadaModularItem extends SwordItem {
	public EspadaModularItem() {
		super(new Tier() {
			public int getUses() {
				return 0;
			}
		...
		}, 3, -3.4f, new Item.Properties().tab(AurorasmpnewModTabs.TAB_AURORA_ITENS).fireResistant());
	}

...
public class WillianMutuwaItem extends SwordItem {
	public WillianMutuwaItem() {
		super(new Tier() {
			public int getUses() {
				return 0;
			}
		...
		}, 3, -1.8f, new Item.Properties().tab(AurorasmpnewModTabs.TAB_AURORA_ITENS).fireResistant());
	}

...
import net.mcreator.aurorasmpnew.procedures.CristalBrancoWhileBaubleIsEquippedTickProcedure;
import net.mcreator.aurorasmpnew.init.AurorasmpnewModTabs;

import java.util.List;

public class CristalBrancoItem extends Item implements ICurioItem {
	public CristalBrancoItem() {
	...
	public void curioTick(SlotContext slotContext, ItemStack stack) {
		CristalBrancoWhileBaubleIsEquippedTickProcedure.execute(slotContext.entity());
	}
}

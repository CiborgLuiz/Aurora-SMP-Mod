...
import net.mcreator.aurorasmpnew.item.model.LivroAuroraItemModel;
...
public class LivroAuroraItemRenderer extends GeoItemRenderer<LivroAuroraItem> implements RendersPlayerArms {
	public LivroAuroraItemRenderer() {
		super(new LivroAuroraItemModel());
	}

	@Override
	public RenderType getRenderType(LivroAuroraItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof LivroAuroraItem) {
	...
	protected LivroAuroraItem animatable;
	...
	@Override
	public void render(GeoModel model, LivroAuroraItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(LivroAuroraItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(LivroAuroraItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(LivroAuroraItem animatable) {

...
import net.mcreator.aurorasmpnew.item.model.LivroAuroraAbertoItemModel;
...
public class LivroAuroraAbertoItemRenderer extends GeoItemRenderer<LivroAuroraAbertoItem> implements RendersPlayerArms {
	public LivroAuroraAbertoItemRenderer() {
		super(new LivroAuroraAbertoItemModel());
	}

	@Override
	public RenderType getRenderType(LivroAuroraAbertoItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof LivroAuroraAbertoItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new LivroAuroraAbertoItemRenderer();
	...
	protected LivroAuroraAbertoItem animatable;
	...
	@Override
	public void render(GeoModel model, LivroAuroraAbertoItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn,
	...
	@Override
	public void render(LivroAuroraAbertoItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(LivroAuroraAbertoItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(LivroAuroraAbertoItem animatable) {

package net.mcreator.aurorasmpnew.item.renderer;
...
import net.mcreator.aurorasmpnew.utils.AnimUtils;
import net.mcreator.aurorasmpnew.item.model.LivroQuePrevePassadoItemModel;
import net.mcreator.aurorasmpnew.item.LivroQuePrevePassadoItem;
import net.mcreator.aurorasmpnew.interfaces.RendersPlayerArms;
...
public class LivroQuePrevePassadoItemRenderer extends GeoItemRenderer<LivroQuePrevePassadoItem> implements RendersPlayerArms {
	public LivroQuePrevePassadoItemRenderer() {
		super(new LivroQuePrevePassadoItemModel());
	}

	@Override
	public RenderType getRenderType(LivroQuePrevePassadoItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof LivroQuePrevePassadoItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new LivroQuePrevePassadoItemRenderer();
	...
	protected LivroQuePrevePassadoItem animatable;
	...
	@Override
	public void render(GeoModel model, LivroQuePrevePassadoItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn,
	...
	@Override
	public void render(LivroQuePrevePassadoItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(LivroQuePrevePassadoItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(LivroQuePrevePassadoItem animatable) {

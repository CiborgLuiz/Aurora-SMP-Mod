...
package net.mcreator.aurorasmpnew.world.dimension;
...
public class AuroraDimensionDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("aurorasmpnew:aurora_dimension"), customEffect));
		}
	}
}
